...
(yearlysales1 = ts(sales, start=c(1980,6), frequency=1)) 
plot(yearlysales1)
# 3rd yr from 1980
...
methods(class=ts)
yearlysales1
(w1=window(yearlysales1,start=1990,end=2013))
plot(w1)
#Quarterly -----
12/4 # freq=4
...
window(dailysales, start=c(2017,1),end=c(2017,10))
head(sales2)
(dailysales=ts(sales2,start=c(2017,1),end=c(2017,7),frequency=365))
plot(dailysales)
