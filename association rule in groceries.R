...
library(datasets.load)  # no need to install, just load it reqd for Groceries
data('Groceries')
Groceries
...
#people who bought baking powder also bought whole milk 91 times with a support(relative value) percentage of 0.925%.No rule(confidence) of less than 0.5 or 50 %.
inspect(rulesc[1:5])
